...
- values supported
  - calculate transformation
    - operation
    - format (format of input, used to parse)
    - unit (of output)
    - adjust_if_day_not_passed (adust year if day hasnt passed for birthday calculation) 
    - round_to_int (round float up or down and return int)
    - decimal_precision (round to specified number of decimal places)
